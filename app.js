...
//reveal and play animation on page load and hide it after//

window.addEventListener('load', function() {
    this.document.getElementById('main-page').classList.add('hidden');
    this.document.getElementById('anim').classList.remove('hidden');
    this.document.body.style.backgroundColor = '#000';

  setTimeout(() => {
    this.document.getElementById('anim').classList.add('hidden');
    this.document.getElementById('main-page').classList.remove('hidden');
